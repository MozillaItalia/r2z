...
ìSi possono includere più lingue, lo script è impostato per le lingue francese e italiano, per aggiungere altre lingue (sperando che funzioni) editare il file langs.txt inserendo il codice della lingua e l'url alla pagina sul sito di OpenOffice del progetto del dizionario.

oftware inclusi nel pacchetto
-------------------------------
	
1. > Super Sed (versione modificata di sed che non necessita di DLL aggiuntive): [SSED][]
